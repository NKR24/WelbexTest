        ...
        <div class={styles.footer}>
          <div class={styles.block1}>
            ...
            <div class={styles.itemOrdinary}>
              <button class={styles.buttons}>Партнёрская программа</button>
              <button class={styles.buttons}>Вакансии</button>
            </div>
          </div>
          ...
          <div class={styles.block3}>
            <div class={styles.itemTitleR}>
              Контакты
            </div>
            <div class={styles.itemOrdinaryR}>
              <button class={styles.numberD}>+7 555 555-55-55</button>
              ...
              <div class={styles.address}>Москва, Путевой проезд 3с1, к 902</div>
            </div>
          </div>
        </div>
        <div class={styles.bottom}>
          <div class={styles.text1}>©WELBEX 2022. Все права защищены.</div>
          <div class={styles.text2}>Политика конфиденциальности</div>
        </div>
      </div>
    </>
  )
